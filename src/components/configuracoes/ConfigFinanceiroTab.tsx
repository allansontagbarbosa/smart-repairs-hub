...
export function ConfigFinanceiroTab({ categoriasFinanceiras, centrosCusto, formasPagamento }: Props) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      <CrudSection title="Categorias Financeiras" items={categoriasFinanceiras} queryKey="categorias_financeiras" table="categorias_financeiras" fields={[{ key: "nome", label: "Nome" }, { key: "tipo", label: "Tipo (fixo/variável)" }]} />
