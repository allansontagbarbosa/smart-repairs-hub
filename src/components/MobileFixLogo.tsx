...
export function MobileFixLogo({ size = 'md', showTagline = false, iconOnly = false }: Props) {
  ...
  return (
    <svg width={530 * s} height={(showTagline ? 120 : 110) * s} viewBox="0 0 530 120" role="img">
      <title>MobileFix</title>
      {/* Escudo */}
      <path d="M50 0 L100 14 L100 58 Q100 90 50 104 Q0 90 0 58 L0 14 Z" fill="#0F172A"/>
      <path d="M50 8 L92 20 L92 58 Q92 84 50 96 Q8 84 8 58 L8 20 Z" fill="#1E40AF"/>
      ...
      <polyline points="39,47 45,54 61,40" fill="none" stroke="#34D399" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
      {/* Wordmark */}
      <text x="118" y="62" fontFamily="system-ui, sans-serif" fontSize="58" fontWeight="500" letterSpacing="-2" fill="#0f172a">Mobile</text>
      <text x="366" y="62" fontFamily="system-ui, sans-serif" fontSize="58" fontWeight="500" letterSpacing="-2" fill="#2563EB">Fix</text>
      {showTagline && (
        <>
          <text x="120" y="90" fontFamily="system-ui, sans-serif" fontSize="13" letterSpacing="4" fill="#64748b">ASSISTÊNCIA TÉCNICA</text>
          <line x1="120" y1="100" x2="490" y2="100" stroke="#e2e8f0" strokeWidth="0.5"/>
        </>
      )}
    </svg>
  )
