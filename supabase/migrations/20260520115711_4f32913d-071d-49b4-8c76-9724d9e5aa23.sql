...
-- FIX 1: Reescrever get_dre_periodo sem movimentacoes_financeiras e sem Impostos de contas_a_pagar
...
-- FIX 2: Restaurar campos faltantes em get_painel_socio_v1
...
BEGIN
  ...
  -- Lista de sócios
  v_socios_lista := COALESCE(v_dre_parcial->'distribuicao'->'socios', '[]'::jsonb);
  ...
  v_saude := jsonb_build_object(
    'gastos_fixos_mes_centavos', ((v_dre_parcial->'despesas'->>'gastos_fixos')::numeric * 100)::bigint,
