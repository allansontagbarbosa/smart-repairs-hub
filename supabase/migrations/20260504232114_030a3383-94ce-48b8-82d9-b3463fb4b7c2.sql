CREATE OR REPLACE FUNCTION public.editar_datas_os_em_massa(p_os_ids uuid[], p_data_conclusao timestamp with time zone DEFAULT NULL::timestamp with time zone, p_data_entrega timestamp with time zone DEFAULT NULL::timestamp with time zone, p_aplicar_conclusao boolean DEFAULT false, p_aplicar_entrega boolean DEFAULT false)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
